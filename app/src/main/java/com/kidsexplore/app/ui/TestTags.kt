 ...
 * on, and in particular nothing saying *which* of a theme's photographs is up.
 * The drawable id in the tag is that missing fact: what matters about this
 * screen is that the expected image is the one that loaded, not what is in it.
 *
